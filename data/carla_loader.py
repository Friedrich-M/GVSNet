...
class Carla(Dataset):
    ...
    def __init__(self, opts):
        ...
        self.train_camera_suffix = [f'_{str(x).zfill(2)}' for x in range(5)] # _00 _01 _02 _03 _04
    ...
    def get_file_list(self):
        if self.opts.mode == 'train':
            ...
            '''
            episode_folders = [
                f'Town0{x}/weather_0{y}' for x in range(1, 6) for y in range(4)] # ['Town01/weather_00', 'Town01/weather_01' .....
            ...
            file_list = [join([self.base_path, epi, cam, f'rgb/{str(x).zfill(6)}.png']) for epi in episode_folders
                            for cam in camera_groups \
                                for x in range(0, 10000, 10)] # .../Town04/weather_03/HorizontalCameras/rgb/009990.png
            return file_list
        else:
